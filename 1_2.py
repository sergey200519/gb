...
# я решил 2 задание не создавая новый список из-за этого я одним кодом решил 2 и 3 задание.
...
# Поменял логику работы функции, также убрал вторую функцию, добавил терные операторы. Уменьшил количество циклов