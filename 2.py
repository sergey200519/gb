class BinaryTree:
    ...
    def insert_left(self, new_node):
        if isinstance(self.right_child, BinaryTree) and self.right_child.get_root_val() < new_node:
            print("error")
    ...
    def insert_right(self, new_node):
        if isinstance(self.left_child, BinaryTree) and self.left_child.get_root_val() > new_node:
            print("error")
        elif self.right_child == None:
